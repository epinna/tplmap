...
class MakoTest(unittest.TestCase, BaseTest):
    ...
    reflection_tests = [
        ...
        (1, '${ "%s" }', { 'prefix': '1"}', 'suffix' : '' }),
        (3, '${ """%s""" }', { 'prefix': '1"""}', 'suffix' : '' }),
        (2, '${ range(%s) }', { 'prefix': '1)}', 'suffix' : '' }),
        (2, '${ set(\'%s\') }', { 'prefix': '1\')}', 'suffix' : '' }),
        (2, '${ set("%s") }', { 'prefix': '1")}', 'suffix' : '' }),
        ...
        (3, '${ {1:"%s"} }', { 'prefix': '1"}}', 'suffix' : '' }),
        (3, '${ {1:"""%s"""} }', { 'prefix': '1"""}}', 'suffix' : '' }),
        (3, '${{3:4, %s:1}}', { 'prefix': '1:1}}', 'suffix' : '' }),
        (3, '${ {\'%s\':1} }', { 'prefix': '1\'}}', 'suffix' : '' }),
        (3, '${ {"%s":1} }', { 'prefix': '1"}}', 'suffix' : '' }),
        (3, '${ {"""%s""":1} }', { 'prefix': '1"""}}', 'suffix' : '' }),
        ...
        (1, '<%% %s %%>', { 'prefix' : '1%>', 'suffix' : '<%#' }),
        (1, '<%%! %s %%>', { 'prefix' : '1%>', 'suffix' : '<%#' }),
        (1, '<%% %s=1 %%>', { 'prefix' : '1%>', 'suffix' : '<%#' }),
        (1, '<%% a=%s %%>', { 'prefix' : '1%>', 'suffix' : '<%#' }),
        (1, '<%% a=\'%s\' %%>', { 'prefix' : '1\'%>', 'suffix' : '<%#' }),
        (1, '<%% a="%s" %%>', { 'prefix' : '1"%>', 'suffix' : '<%#' }),
        (3, '<%% a="""%s""" %%>', { 'prefix' : '1"""%>', 'suffix' : '<%#' }),
        ...
        (4, '<%% a=set([\'%s\']) %%>', { 'prefix' : '1\'])%>', 'suffix' : '<%#' }),
        (4, '<%% a=set(["%s"]) %%>', { 'prefix' : '1"])%>', 'suffix' : '<%#' }),
        (5, '<%% a=set(["""%s"""]) %%>', { 'prefix' : '1"""])%>', 'suffix' : '<%#' }),

        (3, '<%% a={%s} %%>', { 'prefix' : '1}%>', 'suffix' : '<%#' }),
        (3, '<%% a={1:%s} %%>', { 'prefix' : '1}%>', 'suffix' : '<%#' }),
        (3, '<%% a={1:\'%s\'} %%>', { 'prefix' : '1\'}%>', 'suffix' : '<%#' }),
        (3, '<%% a={1:"%s"} %%>', { 'prefix' : '1"}%>', 'suffix' : '<%#' }),
        (3, '<%% a={1:"""%s"""} %%>', { 'prefix' : '1"""}%>', 'suffix' : '<%#' }),
        (3, '<%% a={3:2, %s:1} %%>', { 'prefix' : '1:1}%>', 'suffix' : '<%#' }),
        (3, '<%% a={\'%s\':1}] %%>', { 'prefix' : '1\'}%>', 'suffix' : '<%#' }),
        (3, '<%% a={"%s":1}] %%>', { 'prefix' : '1"}%>', 'suffix' : '<%#' }),
        (3, '<%% a={"""%s""":1} %%>', { 'prefix' : '1"""}%>', 'suffix' : '<%#' }),
